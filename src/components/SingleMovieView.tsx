      ...
      return (
        ...
        >
          <Box
            flex
            background={{
              image: this.props.add
                ? `url(${images[0]})`
                : `url(${images[this.props.rand!]})`,
              dark: true,
              opacity: 0.5
            }}
            justify={this.props.add ? 'center' : 'between'}
            align="center"
            pad="small"
            fill
          >
                ...
                <Box gap="small">
                  <Box justify="center">
                    <Box direction="row" gap="xsmall" justify="center">
                      {this.props.movie.genre.map(
                        (genre: string, i: number) => (
                          <Text weight="bold" key={genre} size="small">
                    ...
                    <Box direction="row" gap="small" justify="center">
                      ...
                      <Text weight="bold" title="Rating" size="small">
            ...
            <Box
              ...
              direction="row"
              justify="between"
              fill={!this.props.add ? 'horizontal' : false}
            >
              <Button
                alignSelf="center"
                title="Back"
              ...
              {!this.props.add && (
                <Button
                  ...
                  title="Remove film"
                  onClick={() => this.props.handleDelete!(this.props.movie.id)}
                />
              )}
            </Box>
          </Box>
                ...
                {this.props.width! < 950 && (
                  ...
                  >
                    <Image
                      fit="cover"
                      src={
                        this.props.add ? images[0] : images[this.props.rand!]
                      }
